...
import { AlertComponent } from '../moduls/alert/alert.component'
import { AlertContent } from '../models/alertContent.model'; 
import {Subject, timer } from 'rxjs';
import { ProductsAlertContentComponent } from '../moduls/products/productsAlertContent/productsAlertContent.component'
...
export class AlertService{
  ...
  showAlertContent(alertContentKey: number, alertItem: string){
    ...
    const alertContainerComponentFactory = this.componentFactoryResolver.resolveComponentFactory(ProductsAlertContentComponent);
